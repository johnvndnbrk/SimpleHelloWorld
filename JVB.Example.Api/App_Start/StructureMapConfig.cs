...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(JVB.Example.Api.StructureMapConfig), "Configure")]
namespace JVB.Example.Api
{
	public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
				...
				cfg.AddRegistry(new ActionFilterRegistry(namespacePrefix: "JVB.Example.Api"));
